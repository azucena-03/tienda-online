...
const XIcon = () => (
    <Link to="https://x.com/home" target="_blank" className="bg-background p-2 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5" fill="currentColor">
