...
function ProductCard({ producto }: ProductoCardProps) {
    return (
        <article className="shadow-md rounded-xl relative">
            <img src={producto.imagen} alt={producto.nombre} className="w-full h-56 object-cover object-center rounded-t-xl bg-radial from-gray-100 via-gray-200 via-50% to-gray-300 to-85%" />
